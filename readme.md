# YOLOv11 Insulator Defect Detection System

## Body

YOLOv11 Insulator Defect Detection System Based on Deep Learning YOLOv11 (YOLOv11+YOLO dataset + UI interface + login registration interface + Python project source code + model)

nc: 4 classes,
Name: ['Broken', 'Flashover damage', 'No issues', 'String'],
Dataset quantity: training set 2240 images, validation set 640 images, test set 320 images.
...
✅ Data visualization: real-time table displaying the category, confidence and coordinates of the detected targets.
